...
- Materialized views: `abandoned_checkout_recovery_events_daily_event_counts_mv`, `abandoned_checkout_recovery_events_daily_conversion_mv`, `abandoned_checkout_recovery_events_segment_success_mv`
