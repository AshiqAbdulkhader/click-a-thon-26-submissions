...
Compose sets `HYPERDX_OTEL_EXPORTER_CLICKHOUSE_DATABASE=otel` and default sources for logs/traces on those tables. OTLP ingest uses the HyperDX team API key (`authorization` header).
